...
const STEPS: Step[] = [
  {
    ...
    detail:
      "Player 1 holds the dealer button (D) and posts the $10 small blind. Player 2 posts the $20 big blind. Heads-up: the button acts first pre-draw, last after each draw.",
    pot: 30,
    p1: { bet: 10, position: "SB", dealt: false },
    p2: { bet: 20, position: "BB", dealt: false },
  },
  {
    street: "Pre-draw",
    action: "Cards dealt",
    ...
    pot: 30,
    justDealt: true,
    p1: { bet: 10, position: "SB" },
    p2: { bet: 20, position: "BB" },
  },
  {
    street: "Pre-draw",
    action: "Player 1 raises to $40",
    detail:
      "Pre-draw uses the small bet ($20). P1 puts in $30 more on top of the blind to make it $40.",
    pot: 60,
    acting: "p1",
    p1: { bet: 40, position: "SB", action: "Raise" },
    p2: { bet: 20, position: "BB" },
  },
  {
    street: "Pre-draw",
    action: "Player 2 re-raises to $60 (3-bet)",
    detail: "P2 reads strength and puts in another $20 bet on top.",
    pot: 100,
    acting: "p2",
    p1: { bet: 40, position: "SB" },
    p2: { bet: 60, position: "BB", action: "3-bet" },
  },
  {
    street: "Pre-draw",
    action: "Player 1 calls",
    detail: "P1 matches the $20. Pre-draw betting closes at $120 in the pot.",
    pot: 120,
    acting: "p1",
    p1: { bet: 60, position: "SB", action: "Call" },
    p2: { bet: 60, position: "BB" },
  },
  {
    street: "Draw 1",
  ...
  {
    street: "Post-draw 1",
    action: "Player 2 bets $20",
    detail: "Post-draw 1 still uses the small bet ($20).",
    pot: 140,
    acting: "p2",
    p1: { bet: 0 },
    p2: { bet: 20, action: "Bet" },
  },
  {
    street: "Post-draw 1",
    action: "Player 1 calls",
    detail: "P1 matches the $20 to see another card.",
    pot: 160,
    acting: "p1",
    p1: { bet: 20, action: "Call" },
    p2: { bet: 20 },
  },
  {
    street: "Draw 2",
  ...
  },
  {
    ...
    detail: "After draw 2 the betting doubles to the big bet ($40).",
    pot: 200,
    acting: "p2",
    p1: { bet: 0 },
...
function StakesBar({ street }: { street: string }) {
  ...
  return (
    <div className="mt-3 flex flex-wrap items-center gap-1.5">
      ...
      <BetSizePill label="Small Bet" amount={20} active={smallActive} />
      <BetSizePill label="Big Bet" amount={40} active={bigActive} />
    </div>
  );
}
